...
public interface ProductService {
    ...
    Page<Product> listByCategory(Long categoryId, Pageable pageable, com.vtcweb.backend.model.entity.product.ProductStatus status);

    Page<Product> searchByName(String name, Pageable pageable);
    Page<Product> searchByName(String name, Pageable pageable, com.vtcweb.backend.model.entity.product.ProductStatus status);
    ...
    Page<Product> listInStockByCategory(Long categoryId, Pageable pageable, com.vtcweb.backend.model.entity.product.ProductStatus status);
    ...
    Page<Product> listOutOfStockByCategory(Long categoryId, Pageable pageable, com.vtcweb.backend.model.entity.product.ProductStatus status);
