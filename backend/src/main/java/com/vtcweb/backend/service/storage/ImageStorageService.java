 ...
 *
 * NOTE: Earlier uploads may exist in legacy folders (e.g. just
 * categories/{id}).
...
public interface ImageStorageService {
	 ...
	 *
	 * These folder names are assembled in the controllers (CategoryImageController
	 * & ProductImageController)
	 * prior to calling upload(). Keeping the logic there avoids coupling this
	 * abstraction to domain entities.
	 */
	...
	/**
	 * Convenience: derive a publicId from a typical Cloudinary secure URL and
	 * delete it.
	 * This is a best-effort helper used when only the URL was persisted. If URL
	 * format
