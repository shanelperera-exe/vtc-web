...
public class EmailProperties {
    ...
    public boolean isUseBrevoApi() {
        return useBrevoApi;
    }

    public void setUseBrevoApi(boolean useBrevoApi) {
        this.useBrevoApi = useBrevoApi;
    }

    public boolean isFallbackToSmtp() {
        return fallbackToSmtp;
    }

    public void setFallbackToSmtp(boolean fallbackToSmtp) {
        this.fallbackToSmtp = fallbackToSmtp;
    }
}
