        ...
        <>
            ...
            <div>
                <div className="flex justify-between text-base font-medium text-gray-900">
                    <h3 className="pr-2">
                        <Link to={`/product/${product?.id}`} className="hover:text-[#04a74b]">
                            {product?.name}
                        </Link>
                    </h3>
            ...
            <div className="mt-2 flex flex-1 items-end justify-between text-xs">
                <div className="flex items-center gap-1">
                    ...
                    <div className="transform scale-[0.65] origin-left ml-1">
                        <QuantityInput
                ...
                <div className="flex">
                    <button
                        ...
                        className="font-medium text-green-700 hover:text-green-800 text-xs mb-1"
                    >
                        Remove
                    </button>
                </div>
