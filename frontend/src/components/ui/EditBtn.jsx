...
const EditBtn = ({ onClick, label = "Edit", noShadow = false }) => {
  if (noShadow) {
    return (
      <button
        type="button"
        onClick={onClick}
        className="inline-flex h-8 items-center gap-2 rounded-xl border border-black/10 bg-white px-3 text-sm font-semibold text-neutral-800 transition-colors hover:border-emerald-600/30 hover:bg-emerald-50 hover:text-emerald-800 focus:outline-none focus:ring-4 focus:ring-emerald-600/15"
      >
