  ...
  if (noShadow) {
    return (
      <button
        type="button"
        onClick={onClick}
        className="inline-flex items-center h-8 px-3 text-sm font-semibold border-3 border-gray-900 bg-white text-black hover:bg-[#09a84e] hover:text-white transition-colors"
      >
        <svg className="h-4 w-4 mr-2" viewBox="0 0 512 512" aria-hidden="true">
