              ...
              <div className="grid w-full grid-cols-1 items-start gap-x-6 gap-y-8 sm:grid-cols-12 lg:gap-x-8">
                {qvProduct.imageSrc ? (
                  <img
                    ...
                    className="aspect-square w-full bg-gray-100 object-cover sm:col-span-4 lg:col-span-5"
                  />
                ) : (
                  <div className="aspect-square w-full bg-gray-100 sm:col-span-4 lg:col-span-5 flex items-center justify-center text-gray-400">No Image</div>
                )}
                    ...
                    <form onSubmit={(e) => { e.preventDefault(); navigate(qvProduct.href); }}>
                      ...
                      <div className="mt-6 flex items-center gap-2">
                        <div style={{ flex: '1 1 auto' }}>
                          <AddToCartBtn product={addToCartPayload} quantity={1} />
                        </div>
