...
export default function AdminLogin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const allow =
        uRoles.includes("ROLE_ADMIN") || uRoles.includes("ROLE_MANAGER");
  ...
  return (
    <div className="relative flex min-h-screen w-full items-start md:items-center justify-center overflow-hidden bg-slate-50 text-neutral-900">
      ...
      {/* Content shell */}
      <div className="relative z-10 flex w-full max-w-3xl md:max-w-6xl flex-col px-4 py-4 md:px-8 lg:px-12">
        {/* Main content */}
        <main className="mt-4 flex flex-1 flex-col gap-6 md:mt-8 md:flex-row md:items-center">
          {/* Left: copy / reassurance */}
          <section className="w-full max-w-xl space-y-4 md:flex-1">
            ...
            <h1 className="text-2xl font-bold uppercase tracking-tight text-neutral-900 sm:text-3xl lg:text-5xl">
              <span className="flex items-center gap-2">
                <RiAdminLine className="h-7 w-7 text-emerald-600 sm:h-9 sm:w-9" />
                <span>Admin Portal</span>
              </span>
              <span className="mt-2 block bg-gradient-to-r from-emerald-700 via-emerald-500 to-emerald-300 bg-clip-text text-transparent">
                Vidara Trade Center
              </span>
            </h1>

            <p className="text-sm leading-relaxed text-neutral-600 sm:text-[15px]">
              Sign in to manage catalog updates, orders, pricing and operational
              workflows in a single, secure interface. All actions are recorded
          ...
          <section className="flex flex-1 items-center justify-center pt-2 md:pt-0">
            <div className="relative w-full max-w-md">
              ...
              <div className="relative flex w-full flex-col justify-center rounded-3xl border-2 border-black bg-white/90 p-6 shadow-xl backdrop-blur-md sm:p-8">
                <div className="mb-5 space-y-2 text-center">
                  ...
                  <div className="flex items-center justify-center gap-2">
                    ...
                    <h2 className="text-xl font-extrabold uppercase tracking-tight text-neutral-900 sm:text-2xl">
                      Admin Sign In
                    </h2>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full rounded-md border-2 border-neutral-900/80 bg-white px-3 py-2 pr-10 text-sm text-neutral-900 placeholder-neutral-400 outline-none transition focus:border-[#0bd964]"
                        placeholder="••••••"
                      />
                      <button
                        type="button"
                ...
                <div className="mt-4 flex flex-col items-center gap-1 text-[10px] font-medium text-neutral-500">
        ...
        <footer className="mt-4 text-[11px] text-center text-neutral-500 md:mt-6">
          ...
          Unauthorized access to this administrative portal is strictly
          prohibited.
        </footer>
      </div>
    </div>
